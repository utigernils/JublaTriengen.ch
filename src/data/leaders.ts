...
export const leaders: Leader[] = [
  {
    ...
    longDescription: 'Sarah ist seit ihrer Kindheit in der Jubla und hat alle Stufen durchlaufen. Als Scharleiterin koordiniert sie das Leitungsteam und ist Ansprechperson für Eltern und Interessierte. Ihre Leidenschaft gilt dem Planen von unvergesslichen Lagern und dem gemütlichen Beisammensein am Lagerfeuer.',
    ...
    jublaHighlight: 'Das Kantonale Sommerlager 2018 mit über 500 Kindern war ein absolutes Highlight. Die Stimmung am grossen Lagerfeuer werde ich nie vergessen.',
  ...
  },
  {
    ...
    longDescription: 'Jan ist der Stratege im Team. Er liebt es, komplexe Geländespiele zu entwickeln, bei denen Taktik und Geschick gefragt sind. Neben seiner Tätigkeit als Scharleiter kümmert er sich auch um die Finanzen der Schar.',
    ...
    jublaHighlight: 'Mein erstes Lager als Leiter, als meine Gruppe den Lagersong gedichtet hat.',
  ...
  },
  {
    ...
    longDescription: 'Lena hat ein grosses Herz für die Kleinsten. Mit viel Geduld und Kreativität gestaltet sie die Gruppenstunden für die jüngsten Jublaner. Sie bastelt und spielt für ihr Leben gern.',
    ...
    jublaHighlight: 'Das Übernachten im Zelt trotz Gewittersturm – wir haben einfach gesungen bis der Sturm vorbei war.',
  ...
  },
  {
    ...
    longDescription: 'Ohne Nico würde im Materialraum Chaos herrschen. Er sorgt dafür, dass Zelte, Blachen und Kochutensilien immer einsatzbereit sind. In den Gruppenstunden ist er für jeden Spass zu haben.',
    ...
    jublaHighlight: 'Der Bau des 10 Meter hohen Sarani-Turms im letzten Sommerlager.',
  ...
  },
  {
    ...
    longDescription: 'Anna ist nicht nur eine tolle Gruppenleiterin, sondern auch eine begnadete Köchin. Im Lager zaubert sie oft leckere Menüs für die ganze Schar. Ihre fröhliche Art ist ansteckend.',
    ...
    jublaHighlight: 'Das riesige Geländespiel "Kampf der Titanen" über zwei Tage.',
  ...
  },
  {
    ...
    longDescription: 'David ist unser Sport-Ass. Egal ob Fussball, Völkerball oder Bulldog, er ist immer mit vollem Einsatz dabei. Er motiviert die Kinder zu mehr Bewegung und Fairplay.',
    ...
    jublaHighlight: 'Der Sieg beim Fussballturnier gegen die Leiter der Nachbarschar.',
